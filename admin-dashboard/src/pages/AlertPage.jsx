  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (form.channels.includes("SMS")) {
        await axios.post(`${BASE}/contacts/sms`, {
          numbers,
      ...
      if (form.channels.includes("IVR Call")) {
        await axios.post(`${BASE}/contacts/ivr`, {
          numbers,
    ...
    <div className="max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">⚠️ Disaster Type</label>
        ...
        <button onClick={handleSend} disabled={sending}
          className="w-full bg-red-500 hover:bg-red-600 disabled:bg-gray-300 text-white font-semibold py-3 rounded-lg transition">
